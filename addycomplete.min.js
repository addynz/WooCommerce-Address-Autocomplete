...
// AddyComplete v2.1.0.1 - https://www.addy.co.nz
function AddyUrlSettingFactory(e){function s(e){e=e.replace(/[\[\]]/g,"\\$&");var s=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)"),d=s.exec(i);return d?d[2]?decodeURIComponent(d[2].replace(/\+/g," ")):"":null}function d(){var s=document.getElementsByTagName("script");e=e.toLowerCase();for(var d=0;d<s.length;d++)if(s[d].src&&-1!==s[d].src.toLowerCase().indexOf(e))return s[d].src;return console.warn("Script source not found. Name: ",e),""}this.createOptions=function(){var e={};return e.excludePostBox=s("excludePostBox")||!1,e.nzCountryValue=s("nzCountryValue")||"NZL",e.maxItems=s("maxItems")||10,e},this.getKey=function(){var e=s("key");return e&&""==e&&console.warn("The API key is missing"),e},this.createCallback=function(){var e=s("callback");return e&&"function"==typeof window[e]?e:null};var i=d(e)}function AddyComplete(e,s){function d(e,s){reqwest({url:i.urlBase+e,type:"jsonp",success:function(e){s(e)}})}if(!e)return void console.warn("Input field is missing");var i=this;i.urlBase="https://www.addy.co.nz/",i.fields=s?s:{},i.options=addySettingsFactory.createOptions(),i.key=addySettingsFactory.getKey();var a=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var s=16*Math.random()|0,d="x"==e?s:3&s|8;return d.toString(16)})},n=a();i.widget=new NeatComplete.Widget(e,{empty_content:"<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.",max_results:i.options.maxItems});var t=null;i.widget.addService("addy",function(e,s){i.fields.country&&i.fields.country.options[i.fields.country.selectedIndex].value!==i.options.nzCountryValue||d("api/search?key="+i.key+"&session="+n+"&expostbox="+i.options.excludePostBox+"&max="+i.options.maxItems+"&s="+e,function(d){i.widget.setOption("max_results",i.options.maxItems),t=new RegExp("("+e.split(" ").join("|")+")","gi");for(var a=new Array,n=0;n<d.addresses.length;n++)a.push({value:d.addresses[n].a,data:d.addresses[n]});s(e,a)})},{renderer:function(e,s){var d=i.widget.getOption("highlight_class");return s.a.replace(t,'<span class="'+(void 0===d?"nc_highlight":d)+'">$1</span>')}}),i.addressSelected=function(e){},i.widget.on("result:select",function(e,s){d("api/address/"+s.id+"?key="+i.key+"&session="+n,function(e){i.fields.address&&(i.fields.address.value=e.displayline),i.fields.suburb&&(i.fields.suburb.value=e.suburb),i.fields.city&&(i.fields.city.value=e.city),i.fields.postcode&&(i.fields.postcode.value=e.postcode),i.fields.line1&&(i.fields.line1.value=e.address1),i.fields.line2&&(i.fields.line2.value=e.address2),i.fields.line3&&(i.fields.line3.value=e.address3),i.fields.line4&&(i.fields.line4.value=e.address4),!i.fields.city&&i.fields.suburb&&""===e.suburb&&""!==e.city&&(i.fields.suburb.value=e.city),i.fields.address1&&i.fields.address2?(e.address4||0===e.address2.indexOf("RD ")?(i.fields.address1.value=e.address1,i.fields.address2.value=e.address2):(i.fields.address1.value=e.displayline,i.fields.address2.value=""),!i.fields.suburb&&e.suburb&&""!==e.suburb&&(""!==i.fields.address2.value&&(i.fields.address1.value+=", "+i.fields.address2.value),i.fields.address2.value=e.suburb)):i.fields.address1&&!i.fields.address2&&(i.fields.address1.value=e.displayline);var s=i.fields.region;if(s)if(s.options){e.region=e.region.toUpperCase();var d=[e.region,e.region.replace("'",""),e.region.replace("-"," - "),e.region.replace("-"," / "),e.region.replace("-","/")];console.log(d);for(var a=0;a<s.options.length;a++)if(d.indexOf(s.options[a].text.toUpperCase())>-1||d.indexOf(s.options[a].value.toUpperCase())>-1){s.selectedIndex=a;break}}else s.value=e.region;i.addressSelected(e)}.bind(this))})}var addySettingsFactory=new AddyUrlSettingFactory("addycomplete"),addyInitCallback=addySettingsFactory.createCallback();addyInitCallback&&window[addyInitCallback]();

// WooCommerce Plug-in
function initAddy(){function e(e){function i(){"NZ"===jQuery("#"+e+"_country").val()?o[e].widget.enable():o[e].widget.disable()}var t=jQuery("#"+e+"_address_1");if(t&&t[0]){var n=new AddyComplete(t[0]);n.fields={address1:t[0],address2:document.getElementById(e+"_address_2"),city:document.getElementById(e+"_city"),postcode:document.getElementById(e+"_postcode")},o[e]=n,n.key=window.addyConfig.key,window.addyConfig.hidePostCode&&"yes"===window.addyConfig.hidePostCode&&(n.options.excludePostBox=!0),n.widget._getPosition=function(){var e=t.offset();return e.top+=t.outerHeight(),e},n.customRegion=jQuery("#"+e+"_state"),n.addressSelected=function(e){if(this.customRegion&&this.customRegion[0]&&this.customRegion[0].options&&""!==e.region){for(var o="",i=0;i<this.customRegion[0].options.length;i++){var t=this.customRegion[0].options[i];(t.text===e.region||t.value===e.region)&&(o=t.value)}""!==o&&this.customRegion.select2().val(o).trigger("change")}};var d=jQuery("#"+e+"_country");d&&d[0]&&d.change(i.bind(this))}}if(!window.addyConfig||!window.addyConfig.key)return void console.warn("The Address Lookup API Key required by Addy is not configured.");var o=[];e("billing"),e("shipping")}!function(){jQuery(document).ready(function(){initAddy()})}();
