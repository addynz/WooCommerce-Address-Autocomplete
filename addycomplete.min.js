...
// AddyComplete v2.1.0.2 - https://www.addy.co.nz
function AddyUrlSettingFactory(s){function t(e){e=e.replace(/[\[\]]/g,"\\$&");var t=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(n);return t?t[2]?decodeURIComponent(t[2].replace(/\+/g," ")):"":null}this.createOptions=function(){var e={};return e.excludePostBox=t("excludePostBox")||!1,e.maxItems=t("maxItems")||10,e.enableLocation=!!t("enableLocation")&&navigator.geolocation,e},this.getKey=function(){var e=t("key");return e&&""==e&&console.warn("The API key is missing"),e},this.createCallback=function(){var e=t("callback");return e&&"function"==typeof window[e]?e:null},this.getLoadCssEnabled=function(){var e=t("loadcss");return e&&"true"===e},this.createGuid=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var t=16*Math.random()|0;return("x"==e?t:3&t|8).toString(16)})};var n=function(){var e=document.getElementsByTagName("script");s=s.toLowerCase();for(var t=0;t<e.length;t++)if(e[t].src&&-1!==e[t].src.toLowerCase().indexOf(s))return e[t].src;return console.warn("Script source not found. Name: ",s),""}()}var addySettingsFactory=new AddyUrlSettingFactory("addycomplete");function AddyComplete(n,e){if(n){var d=this;d.urlBase="https://www.addy.co.nz/",d.fields=e||{},d.mode="address",d.options=addySettingsFactory.createOptions(),d.key=addySettingsFactory.getKey();var o=addySettingsFactory.createGuid(),i=n.placeholder;d.makeRequest=function(e,t,s){reqwest({url:d.urlBase+e+"?key="+d.key+"&v=neat_2_1_0_2&session="+o+t,type:"jsonp",success:function(e){s(e)},error:function(e){console.log("Request failed",e)}})},d.widget=new NeatComplete.Widget(n,{empty_content:"<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.",location_content:"Addresses near me",location_unavailable:"Location information unavailable. Please type in your address.",location_not_found:"No nearby addresses found. Please type in your address.",location_loading:"Loading your location...",max_results:d.options.maxItems});var a=null,r=d.widget.addService("addy",function(o,i){if(o.length<3)return i(o,new Array),void d.widget._hideResults();a=new RegExp("("+o.split(" ").join("|")+")","gi"),"address"===d.mode?d.makeRequest("api/search","&expostbox="+d.options.excludePostBox+"&max="+d.getMaxResults()+"&s="+o,function(e){var t=new Array;if(e)for(var s=0;s<e.addresses.length;s++)t.push({value:e.addresses[s].a,data:e.addresses[s]});i(o,t)}):d.makeRequest("api/postcode","&max="+d.getMaxResults()+"&s="+o,function(e){var t=new Array;if(e)for(var s=0;s<e.postcodes.length;s++){var n=e.postcodes[s];t.push({value:n.suburb+(""===n.suburb?"":", ")+n.city+(""===n.city?"":", ")+n.postcode,data:n})}i(o,t)})},{renderer:function(e,t){var s=d.widget.getOption("highlight_class");return e.replace(a,'<span class="'+(void 0===s?"nc_highlight":s)+'">$1</span>')}});d.setOption=function(e,t){e&&"exclude_postbox"===e?d.options.excludePostBox=t:d.widget.setOption(e,t)},d.getOption=function(e){return d.widget.getOption(e)},d.getMaxResults=function(){return d.widget.getOption("max_results")},d.enableLocation=function(){d.options.enableLocation=!0},d.disableLocation=function(){d.options.enableLocation=!1},d.enable=function(){d.widget.enable()},d.disable=function(){d.widget.disable()},d.setPostcodeMode=function(e){d.mode="postcode",d.setOption("empty_content","Postcode not found. Please verify the spelling.")};NeatComplete.addDomEvent(n,"focus",function(e){d.options.enableLocation&&""===n.value&&r._response(r.last_query,[{value:d.getOption("location_content"),data:{id:"location"}}])}),d._onLocationResultsEmpty=function(e){var t=d.widget.getOption("empty_content");d.options.enableLocation=!1,d.setOption("empty_content",e),setTimeout(function(){d.setOption("empty_content",t)},2e3)},d.handleLocationError=function(e){d.makeRequest("api/errorlog","&message=GeoFailCode:"+e.code+":"+e.message,function(e){}),d._onLocationResultsEmpty(d.getOption("location_unavailable")),r._response(r.last_query,[]),n.placeholder=i},d.reverseGeocode=function(e){d.makeRequest("api/geocode","&x="+e.coords.longitude+"&y="+e.coords.latitude+"&limit="+d.getMaxResults(),function(e){var t=new Array;if(e)for(var s=0;s<e.addresses.length;s++)t.push({value:e.addresses[s].displayname,data:e.addresses[s]});0===t.length&&d._onLocationResultsEmpty(d.getOption("location_not_found")),n.placeholder=i,r._response(r.last_query,t)}.bind(this))},d.addressSelected=function(e){},d.postcodeSelected=function(e){},d.assignAddressFields=function(e){d.fields.address&&(d.fields.address.value=e.displayline),d.fields.suburb&&(d.fields.suburb.value=e.suburb),d.fields.city&&(d.fields.city.value=e.city),d.fields.territory&&(d.fields.territory.value=e.territory),d.fields.x&&(d.fields.x.value=e.x),d.fields.y&&(d.fields.y.value=e.y),d.fields.dpid&&(d.fields.dpid.value=e.dpid),d.fields.id&&(d.fields.id.value=e.id),d.fields.postcode&&(d.fields.postcode.value=e.postcode),d.fields.line1&&(d.fields.line1.value=e.address1),d.fields.line2&&(d.fields.line2.value=e.address2),d.fields.line3&&(d.fields.line3.value=e.address3),d.fields.line4&&(d.fields.line4.value=e.address4),!d.fields.city&&d.fields.suburb&&""===e.suburb&&""!==e.city&&(d.fields.suburb.value=e.city),d.fields.address1&&d.fields.address2?(e.address4||0===e.address2.indexOf("RD ")?(d.fields.address1.value=e.address1,d.fields.address2.value=e.address2):(d.fields.address1.value=e.displayline,d.fields.address2.value=""),!d.fields.suburb&&e.suburb&&""!==e.suburb&&(""!==d.fields.address2.value&&(d.fields.address1.value+=", "+d.fields.address2.value),d.fields.address2.value=e.suburb)):d.fields.address1&&!d.fields.address2&&(d.fields.address1.value=e.displayline)},d.assignRegion=function(e){var t=d.fields.region;if(t)if(t.options){e.region=e.region.toUpperCase();for(var s=[e.region,e.region.replace("'",""),e.region.replace("-"," - "),e.region.replace("-"," / "),e.region.replace("-","/")],n=0;n<t.options.length;n++)if(-1<s.indexOf(t.options[n].text.toUpperCase())||-1<s.indexOf(t.options[n].value.toUpperCase())){t.selectedIndex=n;break}}else t.value=e.region},d.loadAddress=function(e){d.makeRequest("api/address/"+e,"",function(e){e&&(d.assignAddressFields(e),d.assignRegion(e),d.addressSelected(e))}.bind(this))},d.loadLocation=function(){n.value="",n.placeholder=d.getOption("location_loading"),navigator.geolocation.getCurrentPosition(d.reverseGeocode,d.handleLocationError)},d.widget.on("result:select",function(e,t){"address"===d.mode?"location"===t.id?d.loadLocation():d.loadAddress(t.id):d.postcodeSelected(t)}),d.checkDemo=function(){return!(!d.key||"demo-api-key"!==d.key.toLowerCase())&&(d.setOption("footer_content",'<b>Demo Mode:</b> Create a free account at <a href="https://www.addy.co.nz/" class="link-active">addy.co.nz</a>'),!0)},d.checkDemo()}else console.warn("Input field is missing")}function initAddyByCss(){var e=["","2-","3-","4-"],s="addy-";function t(e){var t=document.getElementsByClassName(s+e);return 1===t.length?t[0]:null}for(var n=0;n<e.length;n++){var o=t(e[n]+"line1");if(null!==o)new AddyComplete(o,{address1:o,address2:t(e[n]+"line2"),suburb:t(e[n]+"suburb"),city:t(e[n]+"city"),region:t(e[n]+"region"),territory:t(e[n]+"territory"),postcode:t(e[n]+"postcode"),dpid:t(e[n]+"dpid"),id:t(e[n]+"id"),x:t(e[n]+"x"),y:t(e[n]+"y")})}}function callAddyInit(){var e=addySettingsFactory.createCallback(),t=!1;if(e?(window[e](),t=!0):"function"==typeof initAddy&&(initAddy(),t=!0),t||initAddyByCss(),addySettingsFactory.getLoadCssEnabled()){var s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("type","text/css"),s.setAttribute("href","https://cdn.addy.co.nz/neatcomplete/2.1.0/addycomplete.min.css"),document.getElementsByTagName("head")[0].appendChild(s)}}callAddyInit();
// WooCommerce Plug-in
function initAddy(){function e(e){function i(){"NZ"===jQuery("#"+e+"_country").val()?o[e].widget.enable():o[e].widget.disable()}var t=jQuery("#"+e+"_address_1");if(t&&t[0]){var d=new AddyComplete(t[0]);d.fields={address1:t[0],address2:document.getElementById(e+"_address_2"),city:document.getElementById(e+"_city"),postcode:document.getElementById(e+"_postcode")},o[e]=d,d.key=window.addyConfig.key,window.addyConfig.hidePostCode&&"yes"===window.addyConfig.hidePostCode&&(d.options.excludePostBox=!0),d.widget._getPosition=function(){var e=t.offset();return e.top+=t.outerHeight(),e},d.customRegion=jQuery("#"+e+"_state"),d.addressSelected=function(e){if(this.customRegion&&this.customRegion[0]&&this.customRegion[0].options&&""!==e.region){for(var o="",i=0;i<this.customRegion[0].options.length;i++){var t=this.customRegion[0].options[i];(t.text===e.region||t.value===e.region)&&(o=t.value)}""!==o&&this.customRegion.select2().val(o).trigger("change")}};var n=jQuery("#"+e+"_country");n&&n[0]&&n.change(i.bind(this))}}if(!window.addyConfig||!window.addyConfig.key)return void console.warn("The Address Lookup API Key required by Addy is not configured.");var o=[];e("billing"),e("shipping")}function initAddyDomLoad(e){return 0===e?void initAddy():"complete"===document.readyState?void setTimeout(initAddy,1e3):void setTimeout(function(){initAddyDomLoad(e-1)},1e3)}!function(){jQuery(document).ready(function(){initAddyDomLoad(6)})}();