...
function AddyUrlSettingFactory(e){function s(e){e=e.replace(/[\[\]]/g,"\\$&");var s=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)"),d=s.exec(i);return d?d[2]?decodeURIComponent(d[2].replace(/\+/g," ")):"":null}function d(){var s=document.getElementsByTagName("script");e=e.toLowerCase();for(var d=0;d<s.length;d++)if(s[d].src&&-1!==s[d].src.toLowerCase().indexOf(e))return s[d].src;return console.warn("Script source not found. Name: ",e),""}this.createOptions=function(){var e={};return e.excludePostBox=s("excludePostBox")||!1,e.maxItems=s("maxItems")||10,e},this.getKey=function(){var e=s("key");return e&&""==e&&console.warn("The API key is missing"),e},this.createCallback=function(){var e=s("callback");return e&&"function"==typeof window[e]?e:null};var i=d(e)}function AddyComplete(e,s){function d(e,s){reqwest({url:i.urlBase+e,type:"jsonp",success:function(e){s(e)},error:function(e){console.log("Request failed",e)}})}if(!e)return void console.warn("Input field is missing");var i=this;i.urlBase="https://www.addy.co.nz/",i.fields=s?s:{},i.options=addySettingsFactory.createOptions(),i.key=addySettingsFactory.getKey();var t=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var s=16*Math.random()|0,d="x"==e?s:3&s|8;return d.toString(16)})},a=t();i.widget=new NeatComplete.Widget(e,{empty_content:"<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.",max_results:i.options.maxItems});var n=null;i.widget.addService("addy",function(e,s){return e.length<3?(s(e,new Array),void i.widget._hideResults()):void d("api/search?key="+i.key+"&session="+a+"&expostbox="+i.options.excludePostBox+"&max="+i.widget.getOption("max_results")+"&s="+e,function(d){n=new RegExp("("+e.split(" ").join("|")+")","gi");var i=new Array;if(d)for(var t=0;t<d.addresses.length;t++)i.push({value:d.addresses[t].a,data:d.addresses[t]});s(e,i)})},{renderer:function(e,s){var d=i.widget.getOption("highlight_class");return s.a.replace(n,'<span class="'+(void 0===d?"nc_highlight":d)+'">$1</span>')}}),i.setOption=function(e,s){e&&"exclude_postbox"===e?i.options.excludePostBox=s:i.widget.setOption(e,s)},i.enable=function(){i.widget.enable()},i.disable=function(){i.widget.disable()},i.addressSelected=function(e){},i.widget.on("result:select",function(e,s){d("api/address/"+s.id+"?key="+i.key+"&session="+a,function(e){if(e){i.fields.address&&(i.fields.address.value=e.displayline),i.fields.suburb&&(i.fields.suburb.value=e.suburb),i.fields.city&&(i.fields.city.value=e.city),i.fields.postcode&&(i.fields.postcode.value=e.postcode),i.fields.line1&&(i.fields.line1.value=e.address1),i.fields.line2&&(i.fields.line2.value=e.address2),i.fields.line3&&(i.fields.line3.value=e.address3),i.fields.line4&&(i.fields.line4.value=e.address4),!i.fields.city&&i.fields.suburb&&""===e.suburb&&""!==e.city&&(i.fields.suburb.value=e.city),i.fields.address1&&i.fields.address2?(e.address4||0===e.address2.indexOf("RD ")?(i.fields.address1.value=e.address1,i.fields.address2.value=e.address2):(i.fields.address1.value=e.displayline,i.fields.address2.value=""),!i.fields.suburb&&e.suburb&&""!==e.suburb&&(""!==i.fields.address2.value&&(i.fields.address1.value+=", "+i.fields.address2.value),i.fields.address2.value=e.suburb)):i.fields.address1&&!i.fields.address2&&(i.fields.address1.value=e.displayline);var s=i.fields.region;if(s)if(s.options){e.region=e.region.toUpperCase();var d=[e.region,e.region.replace("'",""),e.region.replace("-"," - "),e.region.replace("-"," / "),e.region.replace("-","/")];console.log(d);for(var t=0;t<s.options.length;t++)if(d.indexOf(s.options[t].text.toUpperCase())>-1||d.indexOf(s.options[t].value.toUpperCase())>-1){s.selectedIndex=t;break}}else s.value=e.region;i.addressSelected(e)}}.bind(this))})}var addySettingsFactory=new AddyUrlSettingFactory("addycomplete"),addyInitCallback=addySettingsFactory.createCallback();addyInitCallback&&window[addyInitCallback]();
// WooCommerce Plug-in
